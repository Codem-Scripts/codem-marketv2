var localesProperty = {
    "USER_WELCOME": "Hello,",
    "USER_BOTTOM_WELCOME_FIRST": "Welcome",
    "USER_BOTTOM_WELCOME_SECOND": "Supermarket",
    "MOST_SALED_ITEMS": "Most saled items",
    "ADD_TO_CARD": "Add To Card",
    "ALL_ITEMS_CATEGORIES": "All",
    "DRINKS_ITEMS_CATEGORIES": "Drinks",
    "FRUITS_ITEMS_CATEGORIES": "Fruits",
    "ALCOHOLS_ITEMS_CATEGORIES": "Alcohols",
    "FASTFOOD_ITEMS_CATEGORIES": "Fast Food",
    "TOOLS_ITEMS_CATEGORIES": "Tools",
    "MEDICALS_ITEMS_CATEGORIES": "Medicals",
    "MY_CARD": "My Card",
...
window.addEventListener("message", function(event) {
    ...
    switch (item.type) {
        case "OPEN_MARKET":
            ...
            $('.userinfoplayername').text('Hello, Mr. '+item.name)
                         ...
                         <div class="item-price">
                           ...
                           <div class="add-to-card-btn">
                             <div class="btn-template" data-price="${valueOfElement.itemPrice}" data-name="${valueOfElement.name}" data-itemName="${valueOfElement.itemName}" data-itemImage="${valueOfElement.itemImage}" data-categories="${valueOfElement.itemCategories}">
                               <p name="add-to-card-select-word">Add To Card</p>
...
$('.close-buton-market').on('click', function() {
    ...
    $.post("https://codem-marketv2/close", JSON.stringify({}));
...
$(document).keydown(function(e) {
    if (e.keyCode == 27) {
        $.post("https://codem-marketv2/close");
        $('body').css('display', 'none');
